...
df_semantic_similarity_patients = pd.read_csv(r'C:\Users\belen\Desktop\Université de Lorraine\703\Aphasia\Data\Processed_data\semantic_data_processed_patients.csv')
